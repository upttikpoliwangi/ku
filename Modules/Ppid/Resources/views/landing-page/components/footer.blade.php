        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1 md:col-span-2">
                <div class="flex items-center mb-4">
                    <div class="w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-lg"
                        ...
                        <img src="{{ asset('logo_poliwangi.jpg') }}" alt="PPID Poliwangi">
                    </div>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <!-- Informasi Publik -->
                    <li>
                        <span class="text-gray-800 font-medium text-sm">Informasi Publik</span>
                        <div class="ml-2 mt-1 space-y-1">
                            <a href="{{ route('publik.i-regulasi.index') }}"
                                class="block text-gray-600 hover:text-gray-900 transition-colors duration-200 text-xs">
                                Regulasi
                            </a>
                    ...
                    <!-- Layanan Informasi -->
                    <li>
                        <span class="text-gray-800 font-medium text-sm">Layanan Informasi</span>
                        <div class="ml-2 mt-1 space-y-1">
                    ...
                    <!-- Publikasi -->
                    <li>
                        <span class="text-gray-800 font-medium text-sm">Publikasi</span>
                        <div class="ml-2 mt-1 space-y-1">
                ...
                <ul class="space-y-3">
                    <li class="text-gray-600 text-sm">
                        ...
                        <a href="" class="hover:text-gray-900 transition-colors duration-200">
                            poliwangi@poliwangi.ac.id, humas@poliwangi.ac.id
                        </a>
                    </li>
                    <li class="text-gray-600 text-sm">
                        <span class="block">Telepon:</span>
                        <a href="tel:+62211234567" class="hover:text-gray-900 transition-colors duration-200">
                            +62 (0333) 636780
                        </a>
                    </li>
                    <li class="text-gray-600 text-sm">
        ...
        <div class="mt-8 pt-8 border-t border-gray-200">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <p class="text-gray-500 text-sm">
                    &copy; {{ date('Y') }} PPID Poliwangi. All rights reserved.
                </p>
